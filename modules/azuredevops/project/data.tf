...
# get project administrators new members attributes         -> main.tf (azuredevops_group_membership.project_administrators)
...
# project's default team (auto-created with project)        -> output.tf (team/import_id_team)
...
# project's default team administrator group(s) attributes  -> main.tf (azuredevops_team_administrators.team_administrators)
...
# project's default repository (auto-created with project)  -> output.tf (git_repository/import_id_git_repository)
